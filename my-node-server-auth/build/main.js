...
/* harmony import */ var _note__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./note */ "./src/note/index.js");
...
protectedApiRouter.use('/item', _note__WEBPACK_IMPORTED_MODULE_6__["router"].routes());
...
const createNote = async (ctx, note, response) => {
  try {
    const userId = ctx.state.user._id;
    note.userId = userId;
    response.body = await _store__WEBPACK_IMPORTED_MODULE_1__["default"].insert(note);
    response.status = 201; // created
...
module.exports = __webpack_require__(/*! G:\Mihnea\Facultate\anu 3\Mobile\start\my-node-server-auth\src/index.js */"./src/index.js");
